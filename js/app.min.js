(() => {
  ...
  document.querySelectorAll(".copy-ca-btn").forEach((t) => {
    ...
    axios
      ...
      .then((t) => {
        const e = t.data.pairs[0].fdv;
        document.getElementById("capValue").textContent = `${Math.floor(
          e / 1e3
        )}`;
      })
      .catch((t) => {
        console.error("Помилка при отриманні даних:", t),
          (document.getElementById("cap").textContent = "552");
      }),
    (window.FLS = !1),
